package com.example.linerotangleleftview
...
fun Canvas.drawLineRotAngleLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLRALNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineRotAngleLeft(scale, w, h, paint)
}

class LineRotAngleLeftView(ctx : Context) : View(ctx) {
    ...
    data class LineRotAngleLeft(var i : Int) {
    ...
    data class Renderer(var view : LineRotAngleLeftView) {

        private val animator : Animator = Animator(view)
        private val lral : LineRotAngleLeft = LineRotAngleLeft(0)
