...
fun Canvas.drawBiLineDropRot(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBLDRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBiLineDropRot(scale, w, h, paint)
}

class BiLineDropRotView(ctx : Context) : View(ctx) {
    ...
    data class BiLineDropRot(var i : Int) {
    ...
    data class Renderer(var view : BiLineDropRotView) {

        private val animator : Animator = Animator(view)
        private val paint : Paint = Paint(Paint.ANTI_ALIAS_FLAG)
        private val bldr : BiLineDropRot = BiLineDropRot(0)
