package com.example.altbirotupview
...
fun Canvas.drawAltBiRotUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawABRUNode(i : Int, scale : Float, paint : Paint) {
    val w : Float = width.toFloat()
    val h : Float = height.toFloat()
    paint.color = Color.parseColor(colors[i])
    drawAltBiRotUp(scale, w, h, paint)
}

class AltBiRotUpView(ctx : Context) : View(ctx) {
    ...
    data class AltBiRotUp(var i : Int) {

        private var curr : ABRUNode = ABRUNode(0)
