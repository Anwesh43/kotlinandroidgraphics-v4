package com.example.arcleftlinecompleteview
...
fun Canvas.drawArcLeftLineComplete(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawALLCNode(i : Int, scale : Float, paint : Paint) {
...
class ArcLeftLineCompleteView(ctx : Context) : View(ctx) {
    ...
    data class ArcLeftLineComplete(var i : Int) {

        private var curr : ALLCNode = ALLCNode(0)
