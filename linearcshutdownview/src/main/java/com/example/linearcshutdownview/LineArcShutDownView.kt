package com.example.linearcshutdownview
...
fun Canvas.drawLineArcShutDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineArcShutDownView(ctx : Context) : View(ctx) {
    ...
    data class LineArcShutDown(var i : Int) {
    ...
    data class Renderer(var view : LineArcShutDownView) {

        private val animator : Animator = Animator(view)
        private val lasd : LineArcShutDown = LineArcShutDown(0)
