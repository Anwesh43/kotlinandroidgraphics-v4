package com.example.linebentsqupview
...
fun Canvas.drawLineBentSqUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBSUNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBentSqUp(scale, w, h, paint)
}

class LineBentSqUpView(ctx : Context) : View(ctx) {
    ...
    data class LineBentSqUp(var i : Int) {
